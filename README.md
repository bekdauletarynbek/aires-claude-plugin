...
Подключает Claude к корпусу проанализированных научных статей: семантический
...
Всё. Ни токена, ни ссылки, ни пароля вводить не нужно: при первом обращении
Claude сам откроет браузер, вы выберете рабочий аккаунт Google — и корпус
подключён.

Если Claude Code уже был запущен, перезапустите его: список MCP читается
при старте.
